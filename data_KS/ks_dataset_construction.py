...
dataset = 5
path = rf'Convolutional_dataset{dataset}'
os.makedirs(path, exist_ok=True)
os.chdir(path)

#%%
def solve_KS(initial_condition, spatial_resolution, time_steps, order=4, corte_transitorio=40_000, save_interval=1e3):
...
u_train, u_hat_train = generar_dataset(6)
...
u_test, u_hat_test = generar_dataset(6)
